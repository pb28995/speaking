    ...
    <div class="col-md-6">
      <section class="login-form">
        <form method="post" action="index.php" role="login" onsubmit="return toSubmit()">
		  ...
		  <input type="text" id="name" name="NNNN" placeholder="Name"  class="form-control input-lg" required />
		  <input type="email" id="email" name="EEEE" placeholder="Email"  class="form-control input-lg" required />
          <textarea style =" resize: vertical; font-size: 18px;
		margin: 5px 0;" type="text" id="desc" name="DDDD" placeholder="Reason to Contact" class="form-control input-lg" required ></textarea>
          

          
          
     
          <input  name="go" type="submit"  class="btn btn-lg btn-primary btn-block" value="Submit">
